...
class CyclingManager
{
	...
	public:
		...
		/** Constructor which takes the number of bounds/constraints. */
		CyclingManager(	int _nV,	/**< Number of bounds to be managed. */
	...
	protected:
		...
		CyclingStatus* status;			/**< Array to store cycling status of all bounds/constraints. */
