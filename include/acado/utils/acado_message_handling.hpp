...
RET_ILLFORMED_HESSIAN_MATRIX,					/**< Hessian matrix is too ill-posed to continue. */
...
RET_RELAXING_QP,								/**< QP needs to be relaxed due to numerical infeasibility. */
...
/* MPC SOLVER */
RET_NONPOSITIVE_WEIGHT, 						/**< Weighting matrices must be positive definite. */
...
/** Retruned by all ACADO funcions
 *  Passes messages back to calling function.
 */
class returnValue {
private:
...
#define ACADOERROR(retval) returnValue("Error "#retval" in file "__FILE__", line "QUOTE(__LINE__)"\n",LVL_ERROR,retval)

/** Macro to return a error, with user message */
#define ACADOERRORTEXT(retval,text) returnValue("Error "#retval" in file "__FILE__", line "QUOTE(__LINE__)", message: "#text"\n",LVL_ERROR,retval)



/** Macro to return a fatal error */
#define ACADOFATAL(retval) returnValue("Fatal error "#retval" in file "__FILE__", line "QUOTE(__LINE__)"\n",LVL_FATAL,retval)

/** Macro to return a fatal error, with user message */
#define ACADOFATALTEXT(retval,text) returnValue("Fatal error "#retval" in file "__FILE__", line "QUOTE(__LINE__)", message: "#text"\n",LVL_FATAL,retval)



/** Macro to return a warning */
#define ACADOWARNING(retval) returnValue("Warning "#retval" in file "__FILE__", line "QUOTE(__LINE__)"\n",LVL_WARNING,retval)

/** Macro to return a warning, with user message */
#define ACADOWARNINGTEXT(retval,text) returnValue("Warning "#retval" in file "__FILE__", line "QUOTE(__LINE__)", message: "#text"\n",LVL_WARNING,retval)
...
#define ACADOINFOTEXT(retval,text) returnValue("Information "#retval" in file "__FILE__", line "QUOTE(__LINE__)", message: "#text"\n",LVL_INFO,retval)
