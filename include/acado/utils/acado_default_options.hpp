...
const int 		defaultUseCondensing = BT_TRUE;										/**< Default value for specifying whether a condesing-based approach shall be used for solving the sub-QP (possible values: BT_TRUE, BT_FALSE). */
