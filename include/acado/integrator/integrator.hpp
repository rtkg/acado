...
/** 
 *	\brief Base class for all kinds of algorithms for integrating differential equations (ODEs or DAEs).
 *
 *	\ingroup AlgorithmInterfaces
 *
 *  The class Integrator serves as a base class for all kinds of algorithms
